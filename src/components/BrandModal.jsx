...
import { createBrand, getAllBrand, handleShowBrandModal, updateBrand } from '../reduxSlicers/brandSlicer'
...
const BrandModal = ({brand}) => {
    ...
    const updateStatus = useSelector(state=>state.brand.updateStatus)
    const updateMessage = useSelector(state=>state.brand.updateMessage)
    const createStatus = useSelector(state=>state.brand.createStatus)
    const createMessage = useSelector(state=>state.brand.createMessage)
    ...
    const handleSubmit = (e)=>{
        ...
        if(brand){
            ...
            data = {name,description,id:brand._id}
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                {brand ? "Update Brand" : "Add new Brand"}
              </h3>
              <button
                type="button"
